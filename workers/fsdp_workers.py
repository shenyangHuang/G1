...
import utils.torch_functional as verl_F
...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
            ...
            from workers.sharding_manager import BaseShardingManager
            ...
            from workers.rollout.vllm_rollout import vllm_mode, vLLMAsyncRollout, vLLMRollout
            from workers.sharding_manager import FSDPVLLMShardingManager
