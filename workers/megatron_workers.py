...
from utils.model import load_mcore_dist_weights, load_megatron_gptmodel_weights
...
class ActorRolloutRefWorker(MegatronWorker):
    ...
    def _build_model_optimizer(self, model_path, optim_config, override_model_config):
        ...
        from utils.megatron.optimizer import get_megatron_optimizer
        from utils.megatron_utils import get_model, init_megatron_optim_config
    ...
    def _build_rollout(self, trust_remote_code=False):
        if self.config.rollout.name == "vllm":
            ...
            from workers.rollout.vllm_rollout import vllm_mode, vLLMRollout
            from workers.sharding_manager.megatron_vllm import MegatronVLLMShardingManager
